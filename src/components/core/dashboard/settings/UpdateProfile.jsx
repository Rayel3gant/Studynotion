      ...
      <>
        <form onSubmit={handleSubmit(submitProfileForm)}>
          ...
          <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
            ...
            <div className="flex flex-col gap-5 lg:flex-row">
              ...
              <div className="flex flex-col gap-2 lg:w-[48%]">
                ...
                <input type="text" name="lastName" id="lastName" placeholder="Enter first name" className="form-style"
            ...
            <div className="flex flex-col gap-5 lg:flex-row">
              ...
              <div className="flex flex-col gap-2 lg:w-[48%]">
                ...
                <input type="text" name="about" id="about" placeholder="Enter Bio Details"
          ...
          <div className="flex justify-end gap-2">
            ...
            <button className='p-2 font-semibold rounded-md bg-yellow-50' type="submit">Save</button>
          </div>
        </form>
      </>
    )
