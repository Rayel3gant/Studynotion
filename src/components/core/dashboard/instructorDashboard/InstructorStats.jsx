            ...
            loading ? (<Loader/>) : courseData.length>0 ?(
                <div className='flex flex-col gap-y-5'>
                    <div className='flex w-full gap-x-16 '>
                        <div className='w-1/2 bg-richblack-800 px-5 py-10 rounded-md'>
                            <InstructorChart data={instructorData}/>
                        </div>

                        <div className='flex flex-col gap-y-2 lg:w-[30%] bg-richblack-800 h-fit px-5 py-10 rounded-md'>
                        ...
                        <div className='flex justify-between'>
                            {
                                courseData.slice(0,3).map((course)=>(
                                    <div>
                                        <img src={course.Thumbnail} className='w-[250px] h-[200px] rounded-md'/>
