...
const MyProfile = () => {
  ...
  return (
    <div>
        <div className='w-full lg:px-20 flex flex-col gap-y-5'>
            ...
            <div className='w-full flex justify-between bg-richblack-700 py-4 px-5 pr-12'>
                <div className='flex gap-x-4'>
                    <div> <img className='aspect-square rounded-full object-cover w-[80px]' src={user?.Image} alt={`profile- ${user?.FirstName}`}/> </div>
            ...
            <div className='w-full flex flex-col gap-y-5  justify-between bg-richblack-700 py-4 px-5 pr-12'>
                ...
                <div className='grid grid-cols-2 grid-rows-3 gap-x-32'>
                    <div>
